...
using imuisample.Class.Views.PhotoView;

namespace imuisample.Class.Messages
{
    [Activity(Label = "BrowserImageActivity")]
    public class BrowserImageActivity : Activity
    {
        ...
        class CustomPagerAdapter : Android.Support.V4.View.PagerAdapter
        {
