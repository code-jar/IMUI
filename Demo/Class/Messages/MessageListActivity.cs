...
namespace imuisample.Class.Messages
{
    ...
    public class MessageListActivity : Activity
    {
        ...
        class MenuClickListener : Java.Lang.Object, CN.Jiguang.Imui.Chatinput.Listener.IOnMenuClickListener
        {
            ...
            public void OnSendFiles(IList<CN.Jiguang.Imui.Chatinput.Model.FileItem> list)
            {
                if (list?.Count == 0)
                {
                    return;
                ...
                list.ToList().ForEach(item =>
                {
                    ...
                    {
                        throw new Java.Lang.RuntimeException("Invalid FileItem type. Must be Type.Image or Type.Video");
                    }
        ...
        class EditTextListener : Java.Lang.Object, CN.Jiguang.Imui.Chatinput.Listener.IOnClickEditTextListener
        {
        ...
        class RecordVoiceListener : Java.Lang.Object, CN.Jiguang.Imui.Chatinput.Listener.IRecordVoiceListener
        {
            ...
            public void OnFinishRecord(Java.IO.File p0, int duration)
            {
        ...
        class CameraCallbackListener : Java.Lang.Object, CN.Jiguang.Imui.Chatinput.Listener.IOnCameraCallbackListener
        {
        ...
        class MsgClickListener : Java.Lang.Object, MsgListAdapter.IOnMsgClickListener
        {
            ...
            public void OnMessageClick(Java.Lang.Object p0)
            {
                ...
                {
                    Intent intent = new Intent(currentContext, typeof(BrowserImageActivity));
        ...
        class PtrHandler : Java.Lang.Object, CN.Jiguang.Imui.Messages.Ptr.IPtrHandler
        {
            private Context currentContext;
            ...
            public void OnRefreshBegin(CN.Jiguang.Imui.Messages.Ptr.PullToRefreshLayout p0)
            {
                LoadNextPage();
            }
